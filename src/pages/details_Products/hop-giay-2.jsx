            ...
            <>
                ...
                <StaticQuery
                    ...
                    query {
                        ...
                        product: file(relativePath: { eq: "duynhat/products/Paper/HG2.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product1: file(relativePath: { eq: "duynhat/products/Paper/HG7.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product2: file(relativePath: { eq: "duynhat/products/Paper/HG6.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
