...
class PortfolioDetails extends Component {
    ...
    render() {
        ...
        return (
            <>
                <SEO 
                    title="Cuộn nhãn - Chi tiết sản phẩm"
                    description="Cuộn nhãn dán chất lượng cao, in theo yêu cầu. Đa dạng kích thước và chất liệu, phù hợp cho mọi ngành hàng từ Duy Nhật."
                    keywords="cuộn nhãn, nhãn cuộn, tem cuộn, in nhãn cuộn, nhãn dán cuộn, sticker cuộn"
                />
                ...
                <StaticQuery
                    ...
                    query {
                        ...
                        product: file(relativePath: { eq: "duynhat/products/Label/IMG_0085-scaled.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product1: file(relativePath: { eq: "duynhat/products/Label/IMG_0084.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product2: file(relativePath: { eq: "duynhat/products/Label/IMG_0094.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product3: file(relativePath: { eq: "duynhat/products/Label/IMG_0089.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product4: file(relativePath: { eq: "duynhat/products/Label/IMG_0070.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                    ...
                    render={data => {
                        ...
                        const relatedProducts = [
                            ...
                            },
                            {
                                name: "Tem & nhãn",
                                category: "Tem, nhãn, và decal",
                                link: "/details_Products/tem-nhan-8",
                                imageFluid: data.product2.childImageSharp.fluid
                            },
                            {
                                name: "Cuộn nhãn",
                                category: "Tem, nhãn, và decal",
                                link: "/details_Products/tem-nhan-7",
                                            ...
                                            <div className="dlab-bnr-inr-entry">
                                                ...
                                                <div className="breadcrumb-row">
                                                    <ul className="list-inline">
                                                        ...
                                                        <li><Link to="#" style={{ fontFamily: 'Merriweather' }}>Cuộn nhãn</Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="col-lg-6 m-b30">
                                                    <div className="rounded overflow-hidden shadow mb-3" style={{ backgroundColor: '#e8e8e8' }}>
                                                        <Img
                                                            ...
                                                            alt="Cuộn nhãn chất lượng cao - Duy Nhật"
                                                            className="img-cover"
