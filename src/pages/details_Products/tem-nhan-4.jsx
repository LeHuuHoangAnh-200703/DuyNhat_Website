...
class PortfolioDetails extends Component {
    ...
    render() {
        ...
        return (
            <>
                <SEO 
                    title="Nhãn dán - Chi tiết sản phẩm"
                    description="Nhãn dán chất lượng cao, đa dạng chất liệu và kích thước. In offset, in kỹ thuật số, giá cạnh tranh từ Duy Nhật."
                    keywords="nhãn dán, sticker, decal, nhãn mác, in nhãn dán, nhãn sản phẩm"
                />
                ...
                <StaticQuery
                    ...
                    query {
                        ...
                        product: file(relativePath: { eq: "duynhat/products/Label/IMG_0070.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                                            ...
                                            <div className="dlab-bnr-inr-entry">
                                                ...
                                                <div className="breadcrumb-row">
                                                    <ul className="list-inline">
                                                        ...
                                                        <li><Link to="#" style={{ fontFamily: 'Merriweather' }}>Nhãn dán</Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
