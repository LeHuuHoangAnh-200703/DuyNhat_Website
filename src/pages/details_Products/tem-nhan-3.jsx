...
class PortfolioDetails extends Component {
    ...
    render() {
        ...
        return (
            <>
                <SEO 
                    title="Nhãn - Chi tiết sản phẩm"
                    description="Nhãn dán, nhãn mác chất lượng cao, in offset và in kỹ thuật số. Đa dạng chất liệu, kích thước, giá cạnh tranh từ Duy Nhật."
                    keywords="nhãn, nhãn dán, nhãn mác, sticker, in nhãn, nhãn sản phẩm, nhãn decal"
                />
                ...
                <StaticQuery
                    ...
                    query {
                        ...
                        product: file(relativePath: { eq: "duynhat/products/Label/IMG_0066.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product1: file(relativePath: { eq: "duynhat/products/Label/IMG_0085-scaled.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        const relatedProducts = [
                            {
                                ...
                                link: "/details_Products/tem-nhan-6",
                                            ...
                                            <div className="dlab-bnr-inr-entry">
                                                ...
                                                <div className="breadcrumb-row">
                                                    <ul className="list-inline">
                                                        ...
                                                        <li><Link to="#" style={{ fontFamily: 'Merriweather' }}>Nhãn</Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="col-lg-6 m-b30">
                                                    <div className="rounded overflow-hidden shadow mb-3" style={{ backgroundColor: '#e8e8e8' }}>
                                                        <Img
                                                            ...
                                                            alt="Nhãn dán chất lượng cao - Duy Nhật"
                                                            className="img-cover"
