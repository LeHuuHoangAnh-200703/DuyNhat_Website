...
class PortfolioDetails extends Component {
    ...
    render() {
        ...
        return (
            <>
                <SEO 
                    title="Túi 3 Biên - Chi tiết sản phẩm"
                    description="Túi 3 biên chất lượng cao, bao bì nhựa linh hoạt cho thực phẩm và sản phẩm tiêu dùng. Đa dạng kích thước, in ấn đẹp mắt từ Duy Nhật."
                    keywords="túi 3 biên, túi nhựa 3 biên, bao bì nhựa, túi đựng thực phẩm, túi zipper, túi đứng"
                />
                ...
                <StaticQuery
                    ...
                    query {
                        ...
                        product: file(relativePath: { eq: "duynhat/products/flexible/3B.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product3: file(relativePath: { eq: "duynhat/products/flexible/8B.JPG.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                    ...
                    render={data => {
                        ...
                        const relatedProducts = [
                            ...
                            },
                            {
                                ...
                                category: "Bao Bì Nhựa",
                                link: "/details_Products/tui-nhua-dt",
                                            ...
                                            <div className="dlab-bnr-inr-entry">
                                                ...
                                                <div className="breadcrumb-row">
                                                    <ul className="list-inline">
                                                        ...
                                                        <li><Link to="#" style={{ fontFamily: 'Merriweather' }}>Túi 3 Biên</Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="col-lg-6 m-b30">
                                                    <div className="rounded overflow-hidden shadow mb-3" style={{ backgroundColor: '#e8e8e8' }}>
                                                        <Img
                                                            ...
                                                            alt="Túi 3 Biên chất lượng cao - Duy Nhật"
                                                            className="img-cover"
