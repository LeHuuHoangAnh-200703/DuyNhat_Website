            ...
            <>
                ...
                <StaticQuery
                    ...
                    query {
                        ...
                        product: file(relativePath: { eq: "duynhat/products/Paper/HG5.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product1: file(relativePath: { eq: "duynhat/products/Paper/HG1.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product2: file(relativePath: { eq: "duynhat/products/Paper/HG4.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product3: file(relativePath: { eq: "duynhat/products/Paper/HG6.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        product4: file(relativePath: { eq: "duynhat/products/Paper/HG3.jpg" }) {
                            childImageSharp {
                                fluid(quality: 100) {
                                    ...GatsbyImageSharpFluid_withWebp
                                }
                        ...
                        const relatedProducts = [
                            {
                                ...
                                link: "/details_Products/hop-giay-1",
                            ...
                            },
                            {
                                name: "Hộp giấy",
                                category: "Bao Bì Giấy",
                                link: "/details_Products/hop-giay-6",
