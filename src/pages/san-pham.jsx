                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12 m-b50 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.3s">
                                            <div class="dlab-box service-box-3">
                                                <div class="dlab-media radius-sm dlab-img-effect fade-in">
                                                    <Link to="/tem-nhan">
                                                        {/* <img src={require('../images/duynhat/factory/DSC_9257.jpg')} alt=""/> */}
                                                        <Img fluid={data.carton.childImageSharp.fluid} alt="" className="dlab-media radius-sm dlab-img-overlay1" />

                                                    </Link>
                                                </div>
                                                <div class="dlab-info">
                                                    <h4 class="title"><Link to="/thung-carton">Thùng Carton</Link></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
